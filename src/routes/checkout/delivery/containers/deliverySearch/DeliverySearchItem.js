...
const DeliverySearchItem = ({
  ...
  // Destructure hooks
  const { setDeliveryLocation, setMapZoom } = useContext(DeliveryContext);
  ...
  const handleSelect = async () => {
    ...
    await setFieldValue("search", description);
    ...
    await setDeliveryLocation({ lat, lng });
...
export default DeliverySearchItem;
